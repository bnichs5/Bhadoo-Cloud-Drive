    ...
    <jsp:attribute name="body_area">
        <section class="dashboard-counts no-padding-bottom center">
            <div class="container-fluid">
                <div class="row bg-white has-shadow">
                	<div class="col-xl-12" style="text-align:center">
	                    <c:choose>
	                        ...
	                        <p style="font-size: 18px; color: black">Welcome to Remote-Upload Cloud Drive Uploader</p>
				<p style="font-size: 15px; color: black">This site has no registration service or user limits.</p> 
				<p style="font-size: 15px; color: black">Once you login to your Google Drive account you can upload any file from it's URL to your Google Drive Account.</p>
				...
				<p style="font-size: 15px; color: black">If you run into an issue you may need to refresh the page after authenticating.</p><br>
