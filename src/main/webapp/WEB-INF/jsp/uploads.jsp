        ...
        <section class="dashboard-counts no-padding-bottom center">
            <div class="container-fluid">
                <div class="row bg-white has-shadow">
	                ...
	                <p style="font-size: 20px; color: #ed3424">You need to Sign In with Google First</p>
			<!--<img src="https://developers.google.com/identity/images/btn_google_signin_dark_normal_web.png" title="Sign in with Google" onclick="window.open('','_new').location.href = 'https://Remote-Upload-cloud-uploader.herokuapp.com/api/oauth/google/redirect'">-->
			</div>
                </div>
            </div>
        </section>
