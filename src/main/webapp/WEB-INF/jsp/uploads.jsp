...
<ui:templete>
    ...
    <jsp:attribute name="body_area">
        ...
        <section class="dashboard-counts no-padding-bottom center">
			...
			<img src="https://developers.google.com/identity/images/btn_google_signin_dark_normal_web.png" title="Sign in with Google" onclick="window.open('','_new').location.href = '/api/oauth/google/redirect'">
			</div>
                </div>
            </div>
        </section>
